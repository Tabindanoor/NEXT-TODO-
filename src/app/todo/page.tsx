...
// }
// const Column = ({ title, headingColor, cards, column, setCards }:column) => {
//   const [active, setActive] = useState(false);

//   const handleDragStart = ({e, card}:any) => {
...
// Add the rest of the components with their types (BurnBarrel, AddCard, Card, DropIndicator)
// ...
